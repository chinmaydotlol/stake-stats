...
export default function StakeStats() {
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      // Ensure winPercentage and lossPercentage are calculated correctly
      const totalGames = data.wins + data.losses
      const winPercentage = totalGames > 0 ? (data.wins / totalGames) * 100 : 0
      const lossPercentage = totalGames > 0 ? (data.losses / totalGames) * 100 : 0
